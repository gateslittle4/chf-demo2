...
Continuer ?`)) return;
          ...
          return /* @__PURE__ */ React.createElement("tr", { key: v.id, className: isSuspendu ? "bg-amber-50/60 border-l-4 border-amber-400" : isReporte ? "bg-indigo-50/60 border-l-4 border-indigo-400" : v.contientErreurs ? "bg-red-50/40 border-l-4 border-red-500" : "hover:bg-gray-50/50" }, /* @__PURE__ */ React.createElement("td", { className: "p-2 text-gray-500" }, v.dateHeure), /* @__PURE__ */ React.createElement("td", { className: "p-2 text-gray-500 whitespace-nowrap" }, v.numeroLot != null ? /* @__PURE__ */ React.createElement("span", { title: v.moisLot ? formaterMoisFr(v.moisLot) : "" }, "Lot ", v.numeroLot, v.moisLot ? ` (${formaterMoisFr(v.moisLot)})` : "") : (v.typePatient || "ONG") === "ONG" ? /* @__PURE__ */ React.createElement("span", { className: "text-amber-600 font-bold", title: "Pas encore inclus dans un lot envoy\xE9 au partenaire" }, "\u2014 sans lot") : /* @__PURE__ */ React.createElement("span", { className: "text-gray-300" }, "\u2014")), /* @__PURE__ */ React.createElement("td", { className: "p-2 font-bold font-sans flex items-center gap-1" }, v.verrouilleFacture && /* @__PURE__ */ React.createElement("span", null, "\u{1F512}"), v.noteSuspension && /* @__PURE__ */ React.createElement("span", { title: `\u{1F4DD} Note : ${v.noteSuspension}`, className: "cursor-help" }, "\u{1F4DD}"), (() => {
