    ...
    "app/AppHospitaliere.js"(exports, module) {
      ...
      function AppHospitaliere({ onQuitter, userRole, userDisplayName, userEmail, roleParDefaut }) {
        ...
        const genererProchainNumDossierAuto = () => {
          const numeros = verifications.map((v) => (v.numDossier || "").trim().match(/^N-(\d+)$/)).filter(Boolean).map((m) => parseInt(m[1], 10));
