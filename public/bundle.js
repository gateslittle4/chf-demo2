(() => {
  ...
  var require_ArchivesPanel = __commonJS({
    "components/ArchivesPanel.js"(exports, module) {
      ...
      var compterMedicaments = (fiche) => {
        var _a;
        return (((_a = fiche == null ? void 0 : fiche.rawState) == null ? void 0 : _a.lignesCalcul) || []).filter((l) => l.type === "med").length;
      };
