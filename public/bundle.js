(() => {
  ...
  var require_constants = __commonJS({
    "utils/constants.js"(exports, module) {
      ...
      var CONFIG_LITS = {
        ...
        prive: { nom: "Salle Priv\xE9", prix: 750, nouveauPrix: 1500 },
      ...
      var prixLit = (typeLit, tarifChoisi) => {
    ...
    "components/GestionStock.js"(exports, module) {
      ...
      function GestionStockPanel({ items, setItems, showToast }) {
        ...
        const ajouterDon = (id, ong, quantiteAjoutee) => {
          const qte = parseFloat(quantiteAjoutee) || 0;
          if (!ong) {
            showToast("Choisis un ONG donateur", "error");
            return;
          }
          if (qte <= 0) {
            showToast("Quantit\xE9 de don invalide", "error");
            return;
          }
          ...
          showToast(`Don enregistr\xE9 : ${ong} \u2192 +${qte}. Ce m\xE9dicament sera factur\xE9 0 \xE0 ${ong}.`, "success");
        };
        const retirerDon = (id, ong) => {
          const updated = items.map((item) => item.id === id ? { ...item, dons: (item.dons || []).filter((d) => d.ong !== ong) } : item);
          sauvegarderStock(updated);
          showToast(`Don de ${ong} retir\xE9 \u2014 ce m\xE9dicament sera de nouveau factur\xE9 normalement \xE0 ${ong}.`, "success");
        };
        const itemsFiltres = items.filter((i) => i.nom.toLowerCase().includes(filtre.toLowerCase()));
        return /* @__PURE__ */ React.createElement("div", { className: "space-y-4 text-xs" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white p-4 rounded-xl border shadow-sm" }, /* @__PURE__ */ React.createElement("h2", { className: "font-bold text-gray-800 mb-3" }, "\u{1F4E6} Gestion des stocks"), /* @__PURE__ */ React.createElement("input", { type: "text", value: filtre, onChange: (e) => setFiltre(e.target.value), placeholder: "Filtrer...", className: "w-full border rounded-lg p-2 mb-4" }), /* @__PURE__ */ React.createElement("div", { className: "overflow-x-auto" }, /* @__PURE__ */ React.createElement("table", { className: "w-full text-left" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { className: "bg-gray-100 text-[10px] text-gray-500 uppercase border-b font-mono" }, /* @__PURE__ */ React.createElement("th", { className: "p-2" }, "M\xE9dicament"), /* @__PURE__ */ React.createElement("th", { className: "p-2 text-center" }, "Prix"), /* @__PURE__ */ React.createElement("th", { className: "p-2 text-center" }, "Stock"), /* @__PURE__ */ React.createElement("th", { className: "p-2 text-center" }, "Seuil"), /* @__PURE__ */ React.createElement("th", { className: "p-2 text-center" }, "Dons ONG (factur\xE9s 0)"), /* @__PURE__ */ React.createElement("th", { className: "p-2 text-center" }, "Actions"))), /* @__PURE__ */ React.createElement("tbody", { className: "divide-y divide-gray-100" }, itemsFiltres.map((item) => {
          const enAlerte = (item.quantite || 0) <= (item.seuilAlerte || 5);
          return /* @__PURE__ */ React.createElement("tr", { key: item.id, className: enAlerte ? "bg-red-50/40" : "hover:bg-gray-50/50" }, /* @__PURE__ */ React.createElement("td", { className: "p-2 font-medium" }, item.nom), /* @__PURE__ */ React.createElement("td", { className: "p-2 text-center font-mono" }, formatGourdes(item.prix), " Gdes"), /* @__PURE__ */ React.createElement("td", { className: "p-2 text-center font-bold" }, editingId === item.id ? /* @__PURE__ */ React.createElement("input", { type: "number", value: editQuantite, onChange: (e) => setEditQuantite(e.target.value), className: "w-16 border rounded p-1 text-center font-mono" }) : /* @__PURE__ */ React.createElement("span", { className: enAlerte ? "text-red-600" : "" }, item.quantite || 0, " ", enAlerte && "\u26A0\uFE0F")), /* @__PURE__ */ React.createElement("td", { className: "p-2 text-center" }, editingId === item.id ? /* @__PURE__ */ React.createElement("input", { type: "number", value: editSeuil, onChange: (e) => setEditSeuil(e.target.value), className: "w-16 border rounded p-1 text-center font-mono" }) : /* @__PURE__ */ React.createElement("span", null, item.seuilAlerte || 5)), /* @__PURE__ */ React.createElement("td", { className: "p-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1 justify-center mb-1" }, (item.dons || []).map((d) => /* @__PURE__ */ React.createElement("span", { key: d.ong, className: "bg-emerald-100 text-emerald-800 rounded px-1.5 py-0.5 text-[10px] font-bold flex items-center gap-1" }, "\u{1F381} ", d.ong, " : ", d.quantite, /* @__PURE__ */ React.createElement("button", { onClick: () => retirerDon(item.id, d.ong), title: "Retirer ce don", className: "text-emerald-900 hover:text-red-600" }, /* @__PURE__ */ React.createElement(X, { size: 9 }))))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 justify-center" }, /* @__PURE__ */ React.createElement("select", { value: donOng[item.id] || "", onChange: (e) => setDonOng({ ...donOng, [item.id]: e.target.value }), className: "border rounded p-0.5 text-[10px]" }, /* @__PURE__ */ React.createElement("option", { value: "" }, "-- ONG --"), LISTE_ONG.map((o) => /* @__PURE__ */ React.createElement("option", { key: o, value: o }, o))), /* @__PURE__ */ React.createElement("input", { type: "number", min: "1", value: donQuantite[item.id] || "", onChange: (e) => setDonQuantite({ ...donQuantite, [item.id]: e.target.value }), placeholder: "Qt\xE9", className: "w-12 border rounded p-0.5 text-center text-[10px]" }), /* @__PURE__ */ React.createElement("button", { onClick: () => ajouterDon(item.id, donOng[item.id], donQuantite[item.id]), className: "bg-emerald-700 text-white px-1.5 py-0.5 rounded text-[10px]" }, "+ Don"))), /* @__PURE__ */ React.createElement("td", { className: "p-2 text-center" }, editingId === item.id ? /* @__PURE__ */ React.createElement("div", { className: "flex justify-center gap-1" }, /* @__PURE__ */ React.createElement("button", { onClick: () => {
  ...
  var require_ArchivesPanel = __commonJS({
    "components/ArchivesPanel.js"(exports, module) {
      ...
      var { CATEGORIES_LISTE, CONFIG_LITS } = require_constants();
      ...
      var MEDICAMENTS_SORTIE_MOTSCLES = ["ferfolat", "globugen", "tothema", "amox", "paracetamol", "vitamine c", "vit c"];
      var MARGE_FICHES_AUTOUR_EXEAT = 3;
      var normaliserTexte = (t) => (t || "").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/\s+/g, " ").trim();
      var estMedicamentSortie = (nomLigne) => {
        const n = normaliserTexte(nomLigne);
        return MEDICAMENTS_SORTIE_MOTSCLES.some((mc) => n.includes(mc));
      };
      var estOxytocine = (nomLigne) => normaliserTexte(nomLigne).includes("oxytocin");
      var dossierAOxytocine = (dossier) => (dossier.fiches || []).some((f) => {
        var _a;
        return (((_a = f.rawState) == null ? void 0 : _a.lignesCalcul) || []).some((l) => l.type === "med" && estOxytocine(l.nom));
      });
      var distanceLevenshtein = (a, b) => {
      ...
      var nomCorrespondApproximativement = (nomDossier, recherche) => {
      ...
      var compterMedicamentsSortie = (fiche) => {
        var _a;
        return (((_a = fiche == null ? void 0 : fiche.rawState) == null ? void 0 : _a.lignesCalcul) || []).filter((l) => l.type === "med" && estMedicamentSortie(l.nom)).length;
      };
      var medicamentsSortieManquants = (dossier) => {
        ...
        if (indexesSejour.length === 0) return false;
        return !indexesSejour.some((i) => {
          ...
          for (let j = debut; j <= fin; j++) {
            if (compterMedicamentsSortie(fiches[j]) >= 2) return true;
          }
          return false;
        });
      };
      ...
      function HistoriqueVerifPanel({ verifications, setVerifications, onChargerPourModif, onSupprimer, filtreInitialNom, clearFiltreInitialNom, userRole, showToast, onChangerTypeOng, listeOng, listeOngDocs, confirmModal, setConfirmModal, lotInitialFocus, clearLotInitialFocus }) {
        ...
        const [moisLotChoisi, setMoisLotChoisi] = useState(() => {
        ...
        const [filtreCategorieLot, setFiltreCategorieLot] = useState("");
        useEffect(() => {
          if (filtreInitialNom) {
        ...
        useEffect(() => {
          setAppliqueRabais10(!!RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne]);
          setMontantDonIntrants("");
          setRechercheLot("");
          setFiltreCategorieLot("");
        }, [lotFocusedNumero, lotOngSelectionne]);
        useEffect(() => {
        ...
        const lotsDuPartenaire = useMemo(() => {
          ...
          return Object.keys(parNumero).map((n) => Number(n)).sort((a, b) => b - a).map((n) => {
            ...
            return {
              ...
              moisLot: ((_a2 = parNumero[n][0]) == null ? void 0 : _a2.moisLot) || null,
              verrouille: !!((_b = parNumero[n][0]) == null ? void 0 : _b.lotVerrouille)
            };
          });
        ...
        const ordinalParDossierLot = useMemo(() => {
          ...
          const m = {};
          lotFocused.dossiers.forEach((v, i) => {
            m[v.id] = i + 1;
          });
          return m;
        }, [lotFocused]);
        ...
        const genererFichierExcelPourLot = async (ongCible, idsDossiers, numeroLot, moisLot) => {
          ...
          try {
            ...
            if (nomsBebesSansMere.length > 0) {
              showToast(`\u26A0\uFE0F B\xE9b\xE9(s) sans dossier de m\xE8re dans ce lot (v\xE9rifie s'il faut une fiche d'urgence) : ${nomsBebesSansMere.join(", ")}`, "info");
            }
            ...
            r++;
            const moisLotFinal = moisLot || ((_a2 = listeDossiersONG[0]) == null ? void 0 : _a2.moisLot) || null;
            ...
            if (moisLotFinal) {
              ...
              const moisRapport = /* @__PURE__ */ new Date();
              moisRapport.setDate(1);
              moisRapport.setMonth(moisRapport.getMonth() - 1);
            ...
            await Promise.all(listeDossiersONG.map(async (d) => {
              try {
                await chf.updateEpisode(d.id, toEpisodeApi({ numeroLot, moisLot: moisLotFinal, verrouilleFacture: true }));
              } catch (e) {
        ...
        const genererProchainLot = (ongCible) => {
          ...
          setConfirmModal({
            ...
            message: `${eligibles.length} dossier(s) seront inclus, pour un total d'environ ${formatGourdes(totalEstime)} Gdes, factur\xE9s sur ${formaterMoisFr(moisLotChoisi)}. Une fois g\xE9n\xE9r\xE9, ce lot sera fig\xE9 : ces dossiers ne seront plus jamais repris automatiquement dans un futur lot.`,
        ...
        const ajouterDossierAuLot = async (idDossier, numeroLot, ongCible) => {
          ...
          if (dossierDuLotExistant == null ? void 0 : dossierDuLotExistant.lotVerrouille) {
            showToast(`\u{1F512} Le Lot ${numeroLot} est verrouill\xE9 (d\xE9j\xE0 approuv\xE9) \u2014 impossible d'y ajouter un nouveau dossier.`, "error");
            return;
          }
          const moisLotExistant = (dossierDuLotExistant == null ? void 0 : dossierDuLotExistant.moisLot) || null;
        ...
        const toggleVerrouLot = async (numeroLot, ongCible, verrouille) => {
          ...
          await Promise.all(idsLot.map(async (id) => {
            try {
              await chf.updateEpisode(id, toEpisodeApi({ lotVerrouille: verrouille }));
            } catch (e) {
              if (!e.isOfflineQueue) echecs++;
            }
          }));
          showToast(`${verrouille ? "\u{1F512} Lot verrouill\xE9" : "\u{1F513} Lot d\xE9verrouill\xE9"}${echecs > 0 ? ` \u2014 \u26A0\uFE0F ${echecs} dossier(s) non enregistr\xE9(s), r\xE9essaie` : ""}`, "success");
        };
        const nomTypeLit = (typeLit) => {
          var _a2;
          return ((_a2 = CONFIG_LITS[typeLit]) == null ? void 0 : _a2.nom) || typeLit;
        };
        const genererCorpsFiche = (dossier, fiche, { afficherTotalDossier } = {}) => {
          var _a2;
          ...
          const fallbackHTML = !hasLignes ? Object.entries(fiche.breakdown || {}).filter(([key, val]) => val > 0).map(([key, val]) => {
            ...
            if (key === "hospit" && fiche.exeat) {
              return `<tr><td>H\xE9bergement \u2014 ${echapperHTML(nomTypeLit(fiche.exeat.typeLit))} (${fiche.exeat.nbJours}j)</td><td class="qte">${fiche.exeat.nbJours}</td><td class="prix">${formatGourdes(fiche.exeat.prixParJour)}</td><td class="sous-total">${formatGourdes(val)}</td></tr>`;
            }
            return `<tr><td>${label}</td><td class="qte">1</td><td class="prix">${formatGourdes(val)}</td><td class="sous-total">${formatGourdes(val)}</td></tr>`;
          }).join("") : "";
          return `<div class="entete"><img class="logo-entete" src="${LOGO_CHF_BASE64}" alt="Logo CHF"/><h1>CHF</h1><p>Centre Hospitalier de Fontaine</p><p>#13, Fontaine Duvivier, Cit\xE9 Soleil</p><p>T\xE9l: (509) 3647-0563 / 2226-8900</p></div><div class="info"><span>Patient: ${echapperHTML(formaterNomPropre(dossier.nomPatient))}</span><span>${dossier.typePatient === "ONG" ? `Partenaire : ${echapperHTML(dossier.ongPartenaire || "N/R")}` : "Priv\xE9"}</span></div><div class="info"><span>Fiche N\xB0${fiche.numeroFiche}</span></div><div class="info info-patient"><span>\u{1F4C1} ${echapperHTML(dossier.numDossier || "N/R")}</span></div>${fiche.exeat ? `<p style="font-size:10px; margin:4px 0;"><strong>S\xE9jour (${echapperHTML(nomTypeLit(fiche.exeat.typeLit))}):</strong> ${fiche.exeat.dateEntree.split("-").reverse().slice(0, 2).join("/")} \u2192 ${fiche.exeat.dateSortie.split("-").reverse().slice(0, 2).join("/")}</p>` : ""}<table><thead><tr><th>D\xE9signation</th><th class="qte">Qt\xE9</th><th class="prix">Prix</th><th class="sous-total">Total</th></tr></thead><tbody>${hasLignes ? lignesHTML : fallbackHTML}</tbody></table><div class="total">TOTAL FICHE : ${formatGourdes(fiche.totalGlobal)} Gdes<br/>${formatDH(fiche.totalGlobal)} DH</div>${afficherTotalDossier ? `<div class="total-dossier">TOTAL DOSSIER : ${formatGourdes(dossier.totalGlobal || 0)} Gdes<br/>${formatDH(dossier.totalGlobal || 0)} DH</div>` : ""}${fiche.solde && fiche.solde > 0 ? `<p style="font-size:12px; color:red;"><strong>Solde restant :</strong> ${formatGourdes(fiche.solde)} Gdes</p>` : ""}<div class="footer">Merci de votre visite !<br/>CHF Syst\xE8me Hospitalier \u2013 ${(/* @__PURE__ */ new Date()).getFullYear()}</div>`;
        };
        const STYLE_FICHE = `@page{size:100mm 297mm;margin:3mm 5mm;}body{font-family:'Courier New',monospace;font-size:14px;color:#000;background:white;margin:0;padding:0;width:90mm;margin:0 auto;}.entete{position:relative;text-align:center;border-bottom:2px dashed #000;padding-bottom:6px;margin-bottom:8px;}.logo-entete{position:absolute;top:0;left:0;width:38px;height:38px;object-fit:contain;}.entete h1{font-size:23px;margin:4px 0;}.entete p{margin:2px 0;font-size:13px;}.info{display:flex;justify-content:space-between;font-weight:bold;font-size:13px;margin-bottom:6px;}table{width:100%;border-collapse:collapse;margin:6px 0;font-size:13px;}th,td{padding:4px 6px;text-align:left;border-bottom:1px dotted #ccc;}th{border-bottom:2px solid #000;font-size:12px;text-transform:uppercase;}.total{font-weight:bold;font-size:19px;text-align:right;border-top:3px solid #000;padding-top:6px;margin-top:6px;}.footer{margin-top:12px;font-size:11px;text-align:center;border-top:1px dashed #ccc;padding-top:6px;color:#555;}.qte{text-align:center;}.prix,.sous-total{text-align:right;}.info-patient{font-size:12px;margin-bottom:4px;}.separation-fiche{border-top:2px dashed #000;margin:10px 0;}.total-dossier{font-weight:bold;font-size:19px;text-align:right;border-top:2px double #000;padding-top:6px;margin-top:6px;}`;
        const imprimerFiche = (fiche) => {
          const estLaDerniereFiche = fiche.numeroFiche === Math.max(...(focusedVerif.fiches || []).map((f) => f.numeroFiche || 0));
          const contenu = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Fiche N\xB0${fiche.numeroFiche}</title><style>${STYLE_FICHE}</style></head><body>${genererCorpsFiche(focusedVerif, fiche, { afficherTotalDossier: estLaDerniereFiche })}</body></html>`;
        ...
        const genererCorpsFormulaireCHF = (dossier) => {
          ...
          const celluleMontant = (montant, estColonneRemplie) => estColonneRemplie && montant > 0 ? `<span class="montant">$${formatDH(montant)}</span>` : `<span class="dollar">$ Ha\xEFtien</span>`;
...
${dossier.noteSuspension}` : ""}`)) return;
        ...
        const toggleDossierComplet = async (dossier) => {
          ...
          try {
            ...
            showToast(nouveauStatut ? `\u2705 Dossier de ${dossier.nomPatient} marqu\xE9 complet` : `Dossier de ${dossier.nomPatient} d\xE9marqu\xE9`, "success");
          } catch (error) {
            if (error.isOfflineQueue) showToast("\u{1F4F4} Changement enregistr\xE9 hors ligne", "info");
            else showToast("Erreur: " + error.message, "error");
          }
        ...
        }, className: "border rounded-lg p-1.5 text-xs bg-white font-bold outline-none max-w-xs" }, /* @__PURE__ */ React.createElement("option", { value: "" }, "-- S\xE9lectionner --"), listeOng.map((o) => /* @__PURE__ */ React.createElement("option", { key: o, value: o }, o)))), lotOngSelectionne && !lotFocused && /* @__PURE__ */ React.createElement(React.Fragment, null, dossiersOrphelinsVerrouilles.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-2 bg-amber-50 border border-amber-300 rounded-lg p-3" }, /* @__PURE__ */ React.createElement("span", { className: "text-amber-800 font-bold" }, "\u26A0\uFE0F ", dossiersOrphelinsVerrouilles.length, " dossier(s) d\xE9j\xE0 envoy\xE9s \xE0 ", lotOngSelectionne, " avant la mise en place des lots \u2014 ", formatGourdes(dossiersOrphelinsVerrouilles.reduce((s, v) => s + (v.totalGlobal || 0), 0)), " Gdes"), /* @__PURE__ */ React.createElement("button", { onClick: () => rattacherOrphelinsAUnLot(lotOngSelectionne), className: "bg-amber-600 text-white font-bold px-2 py-1.5 rounded text-[10px] whitespace-nowrap" }, "Rattacher au prochain lot")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-4 items-center bg-gray-50 p-3 rounded-lg border border-dashed" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-gray-700" }, "\u{1F195} ", dossiersEnAttenteDeLot.length, " dossier(s) en attente \u2014 ", formatGourdes(dossiersEnAttenteDeLot.reduce((s, v) => s + (v.totalGlobal || 0), 0)), " Gdes"), RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne] ? /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-1 font-bold text-purple-900", title: `Rabais de ${RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne]}% fix\xE9 au contrat avec ${lotOngSelectionne} \u2014 toujours appliqu\xE9` }, "\u{1F512} Rabais ", RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne], "% (contractuel)") : /* @__PURE__ */ React.createElement("label", { className: "flex items-center gap-1 font-bold text-purple-900 cursor-pointer" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: appliqueRabais10, onChange: (e) => setAppliqueRabais10(e.target.checked), className: "rounded" }), " Rabais 10%"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement("span", { className: "font-semibold text-gray-500" }, "Dons:"), /* @__PURE__ */ React.createElement("input", { type: "number", min: "0", value: montantDonIntrants, onChange: (e) => setMontantDonIntrants(e.target.value), placeholder: "0", className: "border rounded p-1 w-24 font-mono font-bold text-right text-red-700 outline-none" })), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement("span", { className: "font-semibold text-gray-500" }, "Mois du lot:"), /* @__PURE__ */ React.createElement("input", { type: "month", value: moisLotChoisi, onChange: (e) => setMoisLotChoisi(e.target.value), className: "border rounded p-1 font-mono font-bold outline-none" })), /* @__PURE__ */ React.createElement("button", { onClick: () => genererProchainLot(lotOngSelectionne), className: "bg-purple-700 text-white font-bold px-3 py-1.5 rounded flex items-center gap-1 shadow disabled:opacity-30" }, /* @__PURE__ */ React.createElement(Download, { size: 13 }), " G\xE9n\xE9rer le prochain lot")), /* @__PURE__ */ React.createElement("h3", { className: "font-black text-gray-700 text-xs uppercase border-b pb-1" }, "Lots d\xE9j\xE0 envoy\xE9s"), lotsDuPartenaire.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "text-gray-400 text-center py-3" }, "Aucun lot envoy\xE9 pour ce partenaire encore."), /* @__PURE__ */ React.createElement("div", { className: "divide-y" }, lotsDuPartenaire.map((lot) => /* @__PURE__ */ React.createElement("div", { key: lot.numero, className: "flex justify-between items-center py-2 text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-gray-700 flex items-center flex-wrap gap-1" }, "Lot ", lot.numero, " ", lot.moisLot ? /* @__PURE__ */ React.createElement("span", { className: "bg-blue-100 text-blue-800 font-black px-2 py-0.5 rounded-full" }, formaterMoisFr(lot.moisLot)) : /* @__PURE__ */ React.createElement("span", { className: "bg-gray-200 text-gray-500 font-bold px-2 py-0.5 rounded-full", title: "Aucun mois assign\xE9 \xE0 ce lot" }, "Mois non d\xE9fini"), " \u2014 ", lot.dossiers.length, " dossier(s) \u2014 ", formatGourdes(lot.total), " Gdes", RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne] && /* @__PURE__ */ React.createElement("span", { className: "text-purple-700", title: `Rabais de ${RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne]}% fix\xE9 au contrat \u2014 toujours appliqu\xE9` }, "\u{1F512} ", RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne], "% \u2192 ", formatGourdes(lot.total * (1 - RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne] / 100)), " Gdes"), lot.verrouille && /* @__PURE__ */ React.createElement("span", { className: "text-red-700", title: "Lot approuv\xE9 et verrouill\xE9" }, "\u{1F512}")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setLotFocusedNumero(lot.numero), className: "text-blue-600 font-bold underline" }, "Voir"), /* @__PURE__ */ React.createElement("button", { onClick: () => reimprimerLot(lotOngSelectionne, lot.numero), className: "text-purple-700 font-bold underline" }, "\u{1F504} R\xE9imprimer")))))), lotFocused && /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 border-b pb-1" }, /* @__PURE__ */ React.createElement("h3", { className: "font-black text-gray-700 text-xs uppercase" }, "\u{1F4E6} Lot ", lotFocused.numero, " \u2014 ", lotOngSelectionne, " ", lotFocused.moisLot ? /* @__PURE__ */ React.createElement("span", { className: "ml-1 bg-blue-100 text-blue-800 font-black px-2 py-0.5 rounded-full" }, formaterMoisFr(lotFocused.moisLot)) : /* @__PURE__ */ React.createElement("span", { className: "ml-1 bg-gray-200 text-gray-500 font-bold px-2 py-0.5 rounded-full", title: "Aucun mois assign\xE9 \xE0 ce lot" }, "Mois non d\xE9fini"), " \u2014 ", lotFocused.dossiers.length, " dossier", lotFocused.dossiers.length > 1 ? "s" : "", " \u2014 ", formatGourdes(lotFocused.total), " Gdes", RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne] ? /* @__PURE__ */ React.createElement("span", { className: "ml-1 text-purple-700", title: `Rabais de ${RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne]}% fix\xE9 au contrat \u2014 toujours appliqu\xE9` }, "\u{1F512} ", RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne], "% \u2192 ", formatGourdes(lotFocused.total * (1 - RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne] / 100)), " Gdes") : appliqueRabais10 && /* @__PURE__ */ React.createElement("span", { className: "ml-1 text-purple-700", title: "Rabais 10% coch\xE9 ci-dessous" }, "Rabais 10% \u2192 ", formatGourdes(lotFocused.total * 0.9), " Gdes"), lotFocused.verrouille && /* @__PURE__ */ React.createElement("span", { className: "ml-1 text-red-700", title: "Lot approuv\xE9 et verrouill\xE9 \u2014 aucun nouveau dossier ne peut y \xEAtre ajout\xE9" }, "\u{1F512} Verrouill\xE9")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 items-center" }, /* @__PURE__ */ React.createElement("button", { onClick: () => toggleVerrouLot(lotFocused.numero, lotOngSelectionne, !lotFocused.verrouille), className: `${lotFocused.verrouille ? "bg-red-700" : "bg-gray-500"} text-white font-bold px-2 py-1 rounded text-[10px] flex items-center gap-1`, title: lotFocused.verrouille ? "D\xE9verrouiller ce lot (permet \xE0 nouveau d'y ajouter un dossier)" : "Verrouiller ce lot une fois approuv\xE9 par le partenaire \u2014 emp\xEAche d'y ajouter un nouveau dossier" }, lotFocused.verrouille ? "\u{1F512} Verrouill\xE9" : "\u{1F513} Verrouiller"), /* @__PURE__ */ React.createElement("button", { onClick: () => reimprimerLot(lotOngSelectionne, lotFocused.numero), className: "bg-purple-700 text-white font-bold px-2 py-1 rounded text-[10px] flex items-center gap-1" }, /* @__PURE__ */ React.createElement(Download, { size: 12 }), " R\xE9imprimer ce lot"), /* @__PURE__ */ React.createElement("button", { onClick: () => imprimerFormulaireCHFPourLot(lotFocused.dossiers), className: "bg-indigo-700 text-white font-bold px-2 py-1 rounded text-[10px] flex items-center gap-1", title: "Imprime le Rapport Dioumitrie de chaque dossier de ce lot, un par page" }, /* @__PURE__ */ React.createElement(Printer, { size: 12 }), " Rapports Dioumitrie du lot"), /* @__PURE__ */ React.createElement("button", { onClick: () => imprimerTousLesRecusDuLot(lotFocused.dossiers), className: "bg-gray-700 text-white font-bold px-2 py-1 rounded text-[10px] flex items-center gap-1", title: "Imprime le re\xE7u de chaque fiche de chaque dossier de ce lot, un par page" }, /* @__PURE__ */ React.createElement(Printer, { size: 12 }), " Re\xE7us du lot"), /* @__PURE__ */ React.createElement("button", { onClick: () => setLotFocusedNumero(null) }, /* @__PURE__ */ React.createElement(X, { size: 14 })))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-3 bg-indigo-50 border border-indigo-200 rounded-lg p-2 text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-indigo-800" }, "\u{1F50E} \xC0 v\xE9rifier avant soumission (clique pour voir qui) :"), [["cesarienne", "C\xE9sarienne"], ["accouchement", "Accouchement"], ["chirurgie", "Chirurgie"]].map(([cle, label]) => /* @__PURE__ */ React.createElement("button", { key: cle, onClick: () => setFiltreCategorieLot((f) => f === cle ? "" : cle), className: `font-mono font-bold px-2 py-0.5 rounded ${filtreCategorieLot === cle ? "bg-indigo-700 text-white" : "text-indigo-900 hover:bg-indigo-100"}` }, label, " : ", compteursLotFocused[cle])), filtreCategorieLot && /* @__PURE__ */ React.createElement("button", { onClick: () => setFiltreCategorieLot(""), className: "text-indigo-500 underline" }, "R\xE9initialiser"), /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-[180px] flex items-center gap-1 ml-auto" }, /* @__PURE__ */ React.createElement("input", { type: "text", value: rechercheLot, onChange: (e) => setRechercheLot(e.target.value), placeholder: "\u{1F50D} Chercher un patient dans ce lot...", className: "border rounded p-1 flex-1 outline-none text-xs" }), rechercheLot && /* @__PURE__ */ React.createElement("button", { onClick: () => setRechercheLot(""), className: "text-gray-400 hover:text-gray-600" }, /* @__PURE__ */ React.createElement(X, { size: 12 })))), (filtreCategorieLot || rechercheLot.trim()) && /* @__PURE__ */ React.createElement("p", { className: "text-[10px] text-gray-500" }, dossiersLotAffiches.length, " / ", lotFocused.dossiers.length, " dossier", lotFocused.dossiers.length > 1 ? "s" : "", " affich\xE9", dossiersLotAffiches.length > 1 ? "s" : ""), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-4 bg-amber-50 border border-amber-200 rounded-lg p-2 text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-amber-800" }, "\u{1F4A1} Oubli\xE9 \xE0 la g\xE9n\xE9ration ? Coche/renseigne puis r\xE9imprime ce lot pour l'appliquer :"), RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne] ? /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-1 font-bold text-purple-900", title: `Rabais de ${RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne]}% fix\xE9 au contrat avec ${lotOngSelectionne} \u2014 toujours appliqu\xE9` }, "\u{1F512} Rabais ", RABAIS_CONTRACTUEL_PAR_ONG[lotOngSelectionne], "% (contractuel)") : /* @__PURE__ */ React.createElement("label", { className: "flex items-center gap-1 font-bold text-purple-900 cursor-pointer" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: appliqueRabais10, onChange: (e) => setAppliqueRabais10(e.target.checked), className: "rounded" }), " Rabais 10%"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement("span", { className: "font-semibold text-gray-500" }, "Dons:"), /* @__PURE__ */ React.createElement("input", { type: "number", min: "0", value: montantDonIntrants, onChange: (e) => setMontantDonIntrants(e.target.value), placeholder: "0", className: "border rounded p-1 w-24 font-mono font-bold text-right text-red-700 outline-none" }))), dossiersEnAttenteDeLot.length > 0 && (lotFocused.verrouille ? /* @__PURE__ */ React.createElement("p", { className: "text-[10px] text-red-700 bg-red-50 border border-red-200 rounded-lg p-2" }, "\u{1F512} Ce lot est verrouill\xE9 (d\xE9j\xE0 approuv\xE9) \u2014 d\xE9verrouille-le d'abord pour pouvoir y ajouter un dossier.") : /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 bg-gray-50 border border-dashed rounded-lg p-2" }, /* @__PURE__ */ React.createElement("select", { value: dossierAAjouterAuLot, onChange: (e) => setDossierAAjouterAuLot(e.target.value), className: "border rounded p-1.5 text-xs bg-white flex-1 outline-none" }, /* @__PURE__ */ React.createElement("option", { value: "" }, "-- Ajouter un dossier libre \xE0 ce lot --"), dossiersEnAttenteDeLot.map((v) => /* @__PURE__ */ React.createElement("option", { key: v.id, value: v.id }, v.nomPatient, " \u2014 ", formatGourdes(v.totalGlobal || 0), " Gdes"))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
        ...
        }, disabled: !dossierAAjouterAuLot, className: "bg-emerald-700 text-white font-bold px-2 py-1.5 rounded text-[10px] disabled:opacity-30 whitespace-nowrap" }, "\u2795 Ajouter"))), /* @__PURE__ */ React.createElement("div", { className: "divide-y max-h-[640px] overflow-y-auto" }, dossiersLotAffiches.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "text-gray-400 text-center py-3" }, "Aucun dossier ne correspond \xE0 ce filtre/recherche."), dossiersLotAffiches.map((v) => /* @__PURE__ */ React.createElement("div", { key: v.id, className: "flex justify-between items-start py-2 text-xs font-mono gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0" }, /* @__PURE__ */ React.createElement("span", { className: "inline-flex items-center justify-center h-5 px-1.5 mr-2 bg-gray-700 text-white rounded text-[10px] font-bold whitespace-nowrap", title: "Position dans ce lot \u2014 correspond \xE0 la ligne dans l'Excel envoy\xE9 au partenaire" }, "N-", ordinalParDossierLot[v.id]), /* @__PURE__ */ React.createElement("span", { className: "inline-block sm:w-20 mr-2 sm:mr-2 text-gray-400 font-bold", title: "N\xB0 Dossier" }, v.numDossier ? `N\xB0${v.numDossier}` : ""), /* @__PURE__ */ React.createElement("span", { className: `inline-block sm:w-16 mr-2 sm:mr-3 ${v.dateEntreePourTri && v.dateEntreePourTri !== "9999-12-31" ? "text-gray-500" : "text-red-500"}` }, v.dateEntreePourTri && v.dateEntreePourTri !== "9999-12-31" ? v.dateEntreePourTri.split("-").reverse().join("/") : "sans exeat"), v.nomPatient, " ", /* @__PURE__ */ React.createElement("button", { onClick: () => toggleDossierComplet(v), title: v.dossierComplet ? "Dossier marqu\xE9 complet \u2014 cliquer pour annuler" : "Marquer ce dossier comme complet", className: `inline-flex items-center justify-center w-4 h-4 rounded-full border align-middle mr-1 ${v.dossierComplet ? "bg-emerald-500 border-emerald-600 text-white" : "bg-white border-gray-300 text-gray-300 hover:border-emerald-400 hover:text-emerald-400"}` }, /* @__PURE__ */ React.createElement(Check, { size: 10 })), v.estBebeAvecMere && /* @__PURE__ */ React.createElement("span", { title: `Rattach\xE9 au dossier de ${v.nomMereTrouvee} \u2014 pas besoin d'ouvrir de fiche Admission/Consultation pour ce b\xE9b\xE9, il est d\xE9j\xE0 couvert par celle de sa m\xE8re`, className: "bg-emerald-50 text-emerald-700 border border-emerald-100 text-[9px] font-bold px-1.5 py-0.5 rounded mr-1" }, "\u{1F469} M\xE8re : ", v.nomMereTrouvee), v.estBebeSansMere && /* @__PURE__ */ React.createElement("span", { title: "Aucun dossier de m\xE8re retrouv\xE9 dans tout l'historique \u2014 v\xE9rifie s'il faut ouvrir une fiche d'urgence pour ce b\xE9b\xE9", className: "bg-red-100 text-red-700 text-[9px] font-bold px-1.5 py-0.5 rounded mr-1" }, "\u{1F6A8} Sans m\xE8re"), v.sansExeat && /* @__PURE__ */ React.createElement("span", { title: "Aucun s\xE9jour (exeat) sur ce dossier \u2014 v\xE9rifie s'il a \xE9t\xE9 oubli\xE9", className: "bg-red-100 text-red-700 text-[9px] font-bold px-1.5 py-0.5 rounded mr-1" }, "\u{1F6A8} Sans exeat"), v.orthographeIncoherente && /* @__PURE__ */ React.createElement("span", { title: "Le nom de la m\xE8re tap\xE9 dans ce dossier b\xE9b\xE9 ne correspond pas exactement \xE0 l'orthographe du dossier de la m\xE8re (accents, espaces...) \u2014 harmonise les deux avant l'envoi du lot", className: "bg-amber-100 text-amber-700 text-[9px] font-bold px-1.5 py-0.5 rounded mr-1" }, "\u270F\uFE0F Orthographe m\xE8re/b\xE9b\xE9"), v.cesarienneSansSono && /* @__PURE__ */ React.createElement("span", { title: "C\xE9sarienne ou accouchement factur\xE9, mais aucune sonographie sur ce dossier \u2014 v\xE9rifie si elle a \xE9t\xE9 oubli\xE9e", className: "bg-amber-100 text-amber-700 text-[9px] font-bold px-1.5 py-0.5 rounded mr-1" }, "\u26A0\uFE0F Sono manquante"), v.sansAdmission && /* @__PURE__ */ React.createElement("span", { title: "Aucune Admission / Consultation factur\xE9e sur ce dossier \u2014 v\xE9rifie si elle a \xE9t\xE9 oubli\xE9e", className: "bg-orange-100 text-orange-700 text-[9px] font-bold px-1.5 py-0.5 rounded mr-1" }, "\u26A0\uFE0F Admission manquante"), v.medicamentsSortieManquants && /* @__PURE__ */ React.createElement("span", { title: "S\xE9jour sans au moins 2 m\xE9dicaments de sortie (Ferfolat, Globugen, Tothema, Amox..., Vit C, Parac\xE9tamol) dans la fiche du s\xE9jour ou une fiche adjacente \u2014 v\xE9rifie si les m\xE9dicaments de sortie ont \xE9t\xE9 oubli\xE9s", className: "bg-amber-100 text-amber-700 text-[9px] font-bold px-1.5 py-0.5 rounded mr-1" }, "\u{1F48A} M\xE9dicaments sortie manquants"), v.oxytocineSansAccouchement && /* @__PURE__ */ React.createElement("span", { title: "Oxytocine factur\xE9e mais aucun accouchement ni c\xE9sarienne sur ce dossier \u2014 v\xE9rifie si l'accouchement/la c\xE9sarienne a \xE9t\xE9 oubli\xE9(e) dans la fiche", className: "bg-amber-100 text-amber-700 text-[9px] font-bold px-1.5 py-0.5 rounded mr-1" }, "\u{1F48A} Oxytocine sans accouchement"), /* @__PURE__ */ React.createElement("span", { title: "Nombre de fiches dans ce dossier \u2014 pour v\xE9rifier qu'aucune fiche papier n'a \xE9t\xE9 oubli\xE9e", className: "inline-flex items-center justify-center h-4 px-1 mr-1 bg-blue-50 text-blue-700 border border-blue-100 rounded text-[10px] font-bold align-middle" }, (v.fiches || []).length, " fiche", (v.fiches || []).length > 1 ? "s" : ""), /* @__PURE__ */ React.createElement("span", { className: "text-gray-400" }, "\u2014 ", formatGourdes(v.totalGlobal || 0), " Gdes ", /* @__PURE__ */ React.createElement("span", { className: "text-indigo-400" }, "(", formatDH(v.totalGlobal || 0), " DH)")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1 mt-1 pl-2 sm:pl-40" }, ventilationDossier(v).map((x) => /* @__PURE__ */ React.createElement("span", { key: x.label, className: "bg-indigo-50 text-indigo-700 border border-indigo-100 rounded px-1.5 py-0.5 text-[10px] whitespace-nowrap" }, x.label, ": ", formatDH(x.montant), " DH")))), /* @__PURE__ */ React.createElement("div", { className: "flex gap-1" }, /* @__PURE__ */ React.createElement("button", { onClick: () => imprimerTousLesRecusDuLot([v]), className: "text-gray-600 p-1 bg-gray-50 rounded", title: "Imprimer les re\xE7us de ce patient" }, /* @__PURE__ */ React.createElement(Printer, { size: 13 })), peutModifier && /* @__PURE__ */ React.createElement("button", { onClick: () => {
...
Continuer ?`)) return;
          ...
          return /* @__PURE__ */ React.createElement("tr", { key: v.id, className: isSuspendu ? "bg-amber-50/60 border-l-4 border-amber-400" : isReporte ? "bg-indigo-50/60 border-l-4 border-indigo-400" : v.contientErreurs ? "bg-red-50/40 border-l-4 border-red-500" : "hover:bg-gray-50/50" }, /* @__PURE__ */ React.createElement("td", { className: "p-2 text-gray-500" }, v.dateHeure), /* @__PURE__ */ React.createElement("td", { className: "p-2 text-gray-500 whitespace-nowrap" }, v.numeroLot != null && /* @__PURE__ */ React.createElement("span", { title: v.moisLot ? formaterMoisFr(v.moisLot) : "" }, "Lot ", v.numeroLot, v.moisLot ? ` (${formaterMoisFr(v.moisLot)})` : "")), /* @__PURE__ */ React.createElement("td", { className: "p-2 font-bold font-sans flex items-center gap-1" }, v.verrouilleFacture && /* @__PURE__ */ React.createElement("span", null, "\u{1F512}"), v.noteSuspension && /* @__PURE__ */ React.createElement("span", { title: `\u{1F4DD} Note : ${v.noteSuspension}`, className: "cursor-help" }, "\u{1F4DD}"), (() => {
...
Continuer quand m\xEAme pour corriger ce dossier ?`)) return;
  ...
  var require_Simulateur = __commonJS({
    "components/Simulateur.js"(exports, module) {
      ...
      var { CONFIG_LITS, prixLit, CATEGORIES_LISTE } = require_constants();
  ...
  var require_HebergementForm = __commonJS({
    "components/HebergementForm.js"(exports, module) {
      var React = window.React;
      var { CONFIG_LITS, prixLit } = require_constants();
      var { formatGourdes } = require_helpers();
  ...
  var require_CalculateurPanel = __commonJS({
    "components/CalculateurPanel.js"(exports, module) {
      ...
      var { LOGO_CHF_BASE64 } = require_logoChf();
      var formaterPlageDates = (dateEntree, dateSortie, abrege) => {
        if (!dateEntree) return "";
        const f = (d) => {
          const p = d.split("-").reverse();
          return abrege ? p.slice(0, 2).join("/") : p.join("/");
        };
        return dateSortie && dateSortie !== dateEntree ? `${f(dateEntree)} \u2192 ${f(dateSortie)}` : f(dateEntree);
      };
      var phraseSejour = (dateEntree, dateSortie) => {
        if (!dateEntree) return "";
      ...
      function CalculateurPanel({
        ...
        const genererCorpsTicket = (fiche, { afficherTotalDossier, totalDossier } = {}) => {
          var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j;
          const lignesDetaillees = ((_a = fiche.rawState) == null ? void 0 : _a.lignesCalcul) || [];
          const ligneHebergement = fiche.exeat ? `<tr><td>S\xE9jour : ${echapperHTML(((_b = CONFIG_LITS[fiche.exeat.typeLit]) == null ? void 0 : _b.nom) || fiche.exeat.typeLit)} (${formaterPlageDates(fiche.exeat.dateEntree, fiche.exeat.dateSortie, true)})</td><td class="qte">${fiche.exeat.nbJours}j</td><td class="prix">${formatGourdes(fiche.exeat.prixParJour)}</td><td class="sous-total">${formatGourdes(fiche.exeat.totalHebergement)}</td></tr>` : "";
          const ligneHebergement2 = ((_c = fiche.exeat) == null ? void 0 : _c.multiPeriode) && ((_d = fiche.exeat) == null ? void 0 : _d.dateEntree2) ? `<tr><td>S\xE9jour P2 : ${echapperHTML(((_e = CONFIG_LITS[fiche.exeat.typeLit2]) == null ? void 0 : _e.nom) || fiche.exeat.typeLit2)} (${formaterPlageDates(fiche.exeat.dateEntree2, fiche.exeat.dateSortie2, true)})</td><td class="qte">${fiche.exeat.nbJours2}j</td><td class="prix">${formatGourdes((_g = fiche.exeat.prixParJour2) != null ? _g : ((_f = CONFIG_LITS[fiche.exeat.typeLit2]) == null ? void 0 : _f.prix) || 0)}</td><td class="sous-total">${formatGourdes(fiche.exeat.totalHebergement2)}</td></tr>` : "";
          const prixChirSpecFiche = ((_h = fiche.rawState) == null ? void 0 : _h.hasChirSpec) ? parseFloat(fiche.rawState.prixChirSpec) || 0 : 0;
          const ligneChir = ((_i = fiche.rawState) == null ? void 0 : _i.hasChirSpec) && ((_j = fiche.rawState) == null ? void 0 : _j.nomChirSpec) ? `<tr><td>Chirurgie: ${echapperHTML(fiche.rawState.nomChirSpec)}</td><td class="qte">1</td><td class="prix">${formatGourdes(prixChirSpecFiche)}</td><td class="sous-total">${formatGourdes(prixChirSpecFiche)}</td></tr>` : "";
          return `<div class="entete"><img class="logo-entete" src="${LOGO_CHF_BASE64}" alt="Logo CHF"/><h1>CHF</h1><p>Centre Hospitalier de Fontaine</p><p>#13, Fontaine Duvivier, Cit\xE9 Soleil</p><p>T\xE9l: (509) 3647-0563 / 2226-8900</p></div><div style="font-weight:bold;font-size:11px;margin-bottom:6px;">Patient: ${echapperHTML(formaterNomPropre(nomPatient))}</div><div style="font-size:10px;margin-bottom:2px;">${typePatient === "ONG" ? `Partenaire : ${echapperHTML(selectedOng || "N/R")}` : "Priv\xE9"}</div><table><thead><tr><th>D\xE9signation</th><th class="qte">Qt\xE9</th><th class="prix">Prix</th><th class="sous-total">Total</th></tr></thead><tbody>${ligneHebergement}${ligneHebergement2}${ligneChir}${lignesDetaillees.map((l) => `<tr><td>${echapperHTML(l.nom)}</td><td class="qte">${l.qte}</td><td class="prix">${formatGourdes(l.prix)}</td><td class="sous-total">${formatGourdes(l.qte * l.prix)}</td></tr>`).join("")}</tbody></table><div class="total">TOTAL FICHE : ${formatGourdes(fiche.totalGlobal)} Gdes (${formatDH(fiche.totalGlobal)} DH)</div>${afficherTotalDossier ? `<div class="total-dossier">TOTAL DOSSIER : ${formatGourdes(totalDossier || 0)} Gdes (${formatDH(totalDossier || 0)} DH)</div>` : ""}<p style="font-size:10px;margin-top:4px;">${fiche.prescritPar ? `Prescrit par : ${echapperHTML(fiche.prescritPar)}` : ""}</p><div class="footer">Merci de votre visite ! Bonne gu\xE9rison !<br/>CHF-${(/* @__PURE__ */ new Date()).getFullYear()}</div>`;
        };
        const STYLE_TICKET = `@page{size:100mm 297mm;margin:3mm 5mm;}body{font-family:'Courier New',monospace;font-size:14px;color:#000;width:90mm;margin:0 auto;}.entete{position:relative;text-align:center;border-bottom:2px dashed #000;padding-bottom:6px;margin-bottom:8px;}.logo-entete{position:absolute;top:0;left:0;width:38px;height:38px;object-fit:contain;}.entete h1{font-size:23px;margin:4px 0;}.entete p{margin:2px 0;font-size:13px;}table{width:100%;border-collapse:collapse;margin:6px 0;font-size:13px;}th,td{padding:4px 6px;text-align:left;border-bottom:1px dotted #ccc;}th{border-bottom:2px solid #000;font-size:12px;text-transform:uppercase;}.qte{text-align:center;}.prix,.sous-total{text-align:right;}.total{font-weight:bold;font-size:19px;text-align:right;border-top:3px solid #000;padding-top:6px;margin-top:6px;}.total-dossier{font-weight:bold;font-size:19px;text-align:right;border-top:2px double #000;padding-top:6px;margin-top:6px;}.footer{margin-top:12px;font-size:11px;text-align:center;border-top:1px dashed #ccc;padding-top:6px;color:#555;}.page-fiche{page-break-after:always;}`;
        const reimprimerFicheValidee = (fiche) => {
          const estLaDerniereFiche = fiche.numeroFiche === Math.max(...fichesDossier.map((f) => f.numeroFiche || 0));
          const contenu = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Fiche N\xB0${fiche.numeroFiche}</title><style>${STYLE_TICKET}</style></head><body>${genererCorpsTicket(fiche, { afficherTotalDossier: estLaDerniereFiche, totalDossier: totalDossierGourdes })}</body></html>`;
          const win = window.open("", "_blank", "width=500,height=700");
          if (!win) {
            showToast("Impression bloqu\xE9e par le navigateur. R\xE9essaie en cliquant sur Imprimer \u2014 si \xE7a ne marche toujours pas, demande \xE0 quelqu'un de v\xE9rifier les r\xE9glages.", "error");
            return;
        ...
        const imprimerToutesLesFichesDuDossier = () => {
          ...
          const corps = fichesDossier.map((f, i) => `<div class="page-fiche">${genererCorpsTicket(f, { afficherTotalDossier: i === fichesDossier.length - 1, totalDossier: totalDossierGourdes })}</div>`).join("");
        ...
        const imprimerFicheA4 = () => {
          ...
          const ligneHebergement = data.dateEntree1 && data.dateSortie1 ? `<tr><td>H\xE9bergement \u2014 ${echapperHTML(CONFIG_LITS[data.typeLit1].nom)}</td><td class="qte">${data.j1} j</td><td class="prix">${formatGourdes(prixLit(data.typeLit1, tarifChoisi))}</td><td class="mtotal">${formatGourdes(data.totalE1)}</td></tr>` : "";
          const ligneHebergement2 = data.multiPeriode && data.dateEntree2 && data.dateSortie2 ? `<tr><td>H\xE9bergement (2e p\xE9riode) \u2014 ${echapperHTML(CONFIG_LITS[data.typeLit2].nom)}</td><td class="qte">${data.j2} j</td><td class="prix">${formatGourdes(prixLit(data.typeLit2, tarifChoisi))}</td><td class="mtotal">${formatGourdes(data.totalE2)}</td></tr>` : "";
      ...
      <div class="entete">
        ...
        <div class="entete-droite"><img src="${LOGO_CHF_BASE64}" alt="Logo CHF" style="width:44px;height:44px;object-fit:contain;margin-bottom:4px;"/><p>Fiche N\xB0${numeroFicheReelle}</p></div>
      </div>
      ...
      ${data.dateEntree1 && data.dateSortie1 ? `<p style="font-size:12px;margin-bottom:12px;"><strong>S\xE9jour :</strong> ${phraseSejour(data.dateEntree1, data.dateSortie1)}</p>` : ""}
          ...
          try {
            const fiche = {
              ...
              exeat: dateEntree1 && dateSortie1 ? {
                ...
                nbJours: j1,
                typeLit: typeLit1,
                prixParJour: prixLit(typeLit1, tarifChoisi),
                ...
                typeLit2,
                nbJours2: j2,
                prixParJour2: prixLit(typeLit2, tarifChoisi),
...
(clique pour retirer le marquage)` : "Retirer le marquage \u2014 probl\xE8me r\xE9gl\xE9" : "Tout va bien \u2014 clique pour signaler un probl\xE8me"
  ...
  var require_AppHospitaliere = __commonJS({
    "app/AppHospitaliere.js"(exports, module) {
      ...
      var { CONFIG_LITS, prixLit, CATEGORIES_LISTE, LISTE_ONG } = require_constants();
      ...
      function AppHospitaliere({ onQuitter, userRole, userDisplayName, userEmail, roleParDefaut }) {
        ...
        const enregistrerFicheModifiee = (nouvelleFiche) => {
          ...
          if (suivante) {
            ...
            showToast(`Fiche mise \xE0 jour \u2014 Fiche N\xB0${suivante.numeroFiche} charg\xE9e`, "success");
          } else {
        ...
        const suspendreDossier = async () => {
          ...
          avecFicheEnCoursAjoutee((fichesFinales) => {
            const demanderConfirmation = () => {
              const note = (window.prompt(`Note sur le probl\xE8me \xE0 ne pas oublier pour le dossier de ${nomPatient} (optionnel \u2014 ex: quelle fiche, quel souci) :`, "") || "").trim();
              setConfirmModal({
                titre: "Suspendre ce dossier ?",
                message: `Le dossier de ${nomPatient} sera mis en pause. Il pourra \xEAtre rouvert plus tard depuis les Archives.${note ? `

\u{1F4DD} Note : ${note}` : ""}`,
                confirmLabel: "\u23F8\uFE0F Suspendre",
                onConfirm: () => {
                  setConfirmModal(null);
                  executerSuspension(fichesFinales, note);
                },
                onCancel: () => setConfirmModal(null)
              });
            };
...
` : ""}Cette action est irr\xE9versible \u2014 le dossier et son historique de facturation seront perdus pour de bon.`,
        ...
        const injecterLigneAuCalculateur = (item, cat, qte) => {
          ...
          if (estDonDeCetOng) showToast(`\u{1F381} ${item.nom} factur\xE9 0 \u2014 stock donn\xE9 par ${selectedOng}`, "info");
        ...
        return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen w-full flex flex-col font-sans text-[#1E2A24]" }, /* @__PURE__ */ React.createElement(ToastManager, { toasts, removeToast }), /* @__PURE__ */ React.createElement(ConnectionStatus, null), /* @__PURE__ */ React.createElement(StockAlertBadge, { items: lowStockItems }), avertissementInactivite && /* @__PURE__ */ React.createElement("div", { className: "fixed top-4 left-1/2 -translate-x-1/2 z-[60] bg-amber-500 text-white px-4 py-2.5 rounded-xl shadow-2xl flex items-center gap-3 text-sm font-bold" }, /* @__PURE__ */ React.createElement("span", null, "\u23F3 Tu vas \xEAtre d\xE9connect\xE9(e) dans 2 minutes si tu ne fais rien."), /* @__PURE__ */ React.createElement("button", { onClick: () => setAvertissementInactivite(false), className: "bg-white text-amber-700 px-3 py-1 rounded-lg text-xs font-black whitespace-nowrap" }, "Je suis toujours l\xE0")), confirmModal && /* @__PURE__ */ React.createElement(ConfirmModal, { ...confirmModal }), achatExpressOuvert && /* @__PURE__ */ React.createElement(
          ...
          CalculateurPanel,
          {
            ...
            onMarquerProblemeFiche: marquerProblemeFiche,
            idFicheEnCoursDEdition,
      ...
      function ApplicationRoot() {
        ...
        const [roleParDefaut, setRoleParDefaut] = useState(false);
        useEffect(() => {
        ...
        return /* @__PURE__ */ React.createElement(AppHospitaliere, { onQuitter: () => auth.signOut(), userRole, userDisplayName, userEmail: (_a = auth.currentUser) == null ? void 0 : _a.email, roleParDefaut });
      }
