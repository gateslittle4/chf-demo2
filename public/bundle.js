(() => {
  ...
  var require_icons = __commonJS({
    "utils/icons.js"(exports, module) {
      ...
      var Check2 = ({ size = 15 }) => /* @__PURE__ */ React.createElement("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2" }, /* @__PURE__ */ React.createElement("polyline", { points: "20 6 9 17 4 12" }));
      ...
      module.exports = { Plus, Trash2, Pencil, Check: Check2, X, Search, Eye, Download, ArrowUp, ArrowDown, Printer, Clock, FolderOpen };
    }
  });
  ...
  var require_GrilleEdition = __commonJS({
    "components/GrilleEdition.js"(exports, module) {
      ...
      var { Check: Check2, X, Pencil, Trash2 } = require_icons();
  ...
  var require_GestionStock = __commonJS({
    "components/GestionStock.js"(exports, module) {
      ...
      var { formatGourdes } = require_helpers();
      var { Check: Check2, X, Pencil } = require_icons();
  ...
  var require_ArchivesPanel = __commonJS({
    "components/ArchivesPanel.js"(exports, module) {
      ...
      var { Eye, Pencil, Trash2, Printer, Clock, FolderOpen, X, Download, Check: Check2 } = require_icons();
...
Continuer quand m\xEAme pour corriger ce dossier ?`)) return;
  ...
  var require_CalculateurPanel = __commonJS({
    "components/CalculateurPanel.js"(exports, module) {
      ...
      var { formatGourdes, formatDH, echapperHTML } = require_helpers();
      var { Search, Plus, X, Clock } = require_icons();
...
Pourcentage : ${pourcentageExoneration}%`,
          ...
          onViderFicheActive();
          showToast("Fiche enregistr\xE9e (sans paiement)", "success");
        }, disabled: !peutArchiver, className: "flex-[2] bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl py-3 text-xs font-black shadow-md disabled:opacity-50" }, "\u{1F4BE} Enregistrer la Fiche N\xB0", numeroFicheCourante, " au Dossier"))));
      }
...
${fichesDossier.length} fiche(s) \u2014 le dossier sera cl\xF4tur\xE9 et archiv\xE9.`,
        ...
        const executerSuspension = async () => {
          try {
            await chf.updateEpisode(dossierId, toEpisodeApi({ status: "suspendu", dateSuspension: (/* @__PURE__ */ new Date()).toISOString() }));
