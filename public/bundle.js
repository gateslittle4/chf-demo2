(() => {
  ...
  var require_ArchivesPanel = __commonJS({
    "components/ArchivesPanel.js"(exports, module) {
      ...
      var normaliserTexte = (t) => (t || "").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "");
      ...
      var cleFamilleDossier = (nom) => extraireNomMere(nom) || (nom || "").trim().toLowerCase();
      var trierAvecRegroupementMereBebe = (dossiersDuLot, tousLesDossiers) => {
        ...
        poolRecherche.forEach((v) => {
          if (!extraireNomMere(v.nomPatient)) dateMereParCle[cleFamilleDossier(v.nomPatient)] = v.dateEntreePourTri;
        });
    ...
    "components/CalculateurPanel.js"(exports, module) {
      ...
      function CalculateurPanel({
        ...
        const genererCorpsTicket = (fiche) => {
          ...
          const ligneHebergement = fiche.exeat ? `<tr><td>S\xE9jour : ${echapperHTML(((_b = CONFIG_LITS[fiche.exeat.typeLit]) == null ? void 0 : _b.nom) || fiche.exeat.typeLit)}</td><td class="qte">${fiche.exeat.nbJours}j</td><td class="prix">${formatGourdes(fiche.exeat.prixParJour)}</td><td class="sous-total">${formatGourdes(fiche.exeat.totalHebergement)}</td></tr>` : "";
