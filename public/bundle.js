      ...
      .page-formulaire:last-child{page-break-after:auto;}`;
        ...
        const imprimerFormulaireCHFPourLot = (dossiers) => {
          ...
          if (dossiersIncomplets.length > 0) {
            showToast(`\u26A0\uFE0F ${dossiersIncomplets.length} formulaire(s) ne couvrent pas toutes les cat\xE9gories factur\xE9es (ex. Radiographie / Visite) : ${dossiersIncomplets.join(", ")}`, "info");
          }
...
Continuer ?`)) return;
          ...
          return /* @__PURE__ */ React.createElement("tr", { key: v.id, className: isSuspendu ? "bg-amber-50/60 border-l-4 border-amber-400" : isReporte ? "bg-indigo-50/60 border-l-4 border-indigo-400" : v.contientErreurs ? "bg-red-50/40 border-l-4 border-red-500" : "hover:bg-gray-50/50" }, /* @__PURE__ */ React.createElement("td", { className: "p-2 text-gray-500" }, v.dateHeure), /* @__PURE__ */ React.createElement("td", { className: "p-2 text-gray-500" }, v.numDossier || "\u2014"), /* @__PURE__ */ React.createElement("td", { className: "p-2 font-bold font-sans flex items-center gap-1" }, v.verrouilleFacture && /* @__PURE__ */ React.createElement("span", null, "\u{1F512}"), v.noteSuspension && /* @__PURE__ */ React.createElement("span", { title: `\u{1F4DD} Note : ${v.noteSuspension}`, className: "cursor-help" }, "\u{1F4DD}"), (() => {
