      ...
      <div className="bg-white p-4 rounded-xl border shadow-sm">
        ...
        <div className="space-y-3 mt-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div><label className="text-[10px] font-bold text-gray-500 uppercase">Date entrée</label><ChampDateJJMMAAAA value={dateEntree1} onChange={setDateEntree1} className="border rounded-lg p-1.5 text-xs w-full" /></div>
            <div><label className="text-[10px] font-bold text-gray-500 uppercase">Date sortie</label><ChampDateJJMMAAAA value={dateSortie1} onChange={setDateSortie1} className="border rounded-lg p-1.5 text-xs w-full" /></div>
