...
const ChampDateJJMMAAAA = require('./ChampDateJJMMAAAA');
  ...
  return (
    <div className="bg-white p-4 rounded-xl border space-y-3 shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div><label className="text-[10px] font-bold text-gray-500 uppercase">Date d'entrée</label><ChampDateJJMMAAAA value={dateEntree1} onChange={setDateEntree1} className="border rounded-lg p-1.5 text-xs w-full" /></div>
        <div><label className="text-[10px] font-bold text-gray-500 uppercase">Date de sortie</label><ChampDateJJMMAAAA value={dateSortie1} onChange={setDateSortie1} className="border rounded-lg p-1.5 text-xs w-full" /></div>
      ...
      {multiPeriode && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 bg-amber-50/20 p-2 rounded-lg border">
          <div><label className="text-[9px] font-bold text-amber-800">Entrée P2</label><ChampDateJJMMAAAA value={dateEntree2} onChange={setDateEntree2} className="border rounded-lg p-1 text-xs w-full bg-white" /></div>
          <div><label className="text-[9px] font-bold text-amber-800">Sortie P2</label><ChampDateJJMMAAAA value={dateSortie2} onChange={setDateSortie2} className="border rounded-lg p-1 text-xs w-full bg-white" /></div>
